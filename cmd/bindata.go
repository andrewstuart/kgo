...
func templatesMakefile() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/Makefile", size: 420, mode: os.FileMode(420), modTime: time.Unix(1541572795, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
